...
namespace blowbox
{
	...
	void Cube::CreateBuffers()
	{
		std::vector<Vertex> verts({
			// Front Face
			Vertex(-1.0f, -1.0f, -1.0f, 0.0f, 1.0f, 0, 0, 0, 0, 0, 0),
			Vertex(-1.0f, 1.0f, -1.0f, 0.0f, 0.0f, 0, 0, 0, 0, 0, 0),
			Vertex(1.0f, 1.0f, -1.0f, 1.0f, 0.0f, 0, 0, 0, 0, 0, 0),
			Vertex(1.0f, -1.0f, -1.0f, 1.0f, 1.0f, 0, 0, 0, 0, 0, 0),
